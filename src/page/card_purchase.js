...
<div className="container">
  <main>
    ...
    <div className="py-5 text-center ">
      ...
      <h2>Compra de Tarjeta - RIFD</h2>
      <p className="lead">Favor ingrese los datos para la compra de Tarjeta RIDF.</p>
      ...
      <div className="row g-1 justify-content-center shadow p-5 bg-light border m-2">
          ...
          <div className="col-md-5 col-lg-5 order-md-last">         
            <h4 class="d-flex justify-content-between align-items-center mb-3">
              <span class="text-primary">Datos - Compra</span>
          ...
          <div className="col-md-7 col-lg-7">
            <h4 className="mb-3">Datos de Entraga</h4>

...
<div className="container">
  <main>
    ...
    <div className="py-5 text-center ">
      ...
      <h2>Recarga de Tarjeta - RIFD</h2>
      <p className="lead">Favor ingrese los datos para la Recarga de Tarjeta RIDF.</p>
      ...
      <div className="row g-1 justify-content-center shadow p-5 bg-light border m-2">
          ...
          <div className="col-md-5 col-lg-5 order-md-last">         
            <h4 class="d-flex justify-content-between align-items-center mb-3">
              <span class="text-primary">Datos - Recarga</span>
            ...
            <div className="row gy-3">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button type="submit" class="w-100 btn btn-sm btn-outline-secondary">Recargar</button>
          ...
          <div className="col-md-7 col-lg-7">
            <h4 className="mb-3">Datos - Tarjeta</h4>
              ...
              <div className="row g-3">
                ...
                <label  className="form-label" for="type_doc" >Información Saldo Tarjeta RIFD</label>
                <ul className="list-group mb-3 my-3 col-sm-11">
                  <li className="list-group-item d-flex justify-content-between lh-sm">
                    <div>
                      <h6 className="my-0">Saldo Tarjeta:</h6>

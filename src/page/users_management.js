...
const UsersManagement = () => {
  ...
  <main>
    ...
    <div className="py-5 text-center ">
      ...
      <h2>Administración - Usuarios Externo</h2>
      <p className="lead">Favor ingrese los datos para la Gestión de Usuarios Externos.</p>
    ...
    <div className="row g-1 justify-content-center shadow p-5 bg-light border m-2">
      ...
      <div className="col-md-7 col-lg-8">
        <h4 className="mb-3">Sistema de Peajes / Usuarios Externos</h4>
        <hr className="my-1"/>
          ...
          <div className="row g-3">
            ...
            <div className="col-sm-6">
              ...
              <div className="form-group">
                ...
                <Profile/>{/* <Lla al componente que esta leyendo un Json/>  */}
              </div>               
            </div>
            <div className="col-sm-6">
            ...
            <div className="col-sm-6">
              <div className="form-group">
                ...
                <label className="form-label">Saldo Tarjeta RIFD</label>
            ...
            <hr className="my-1"/>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  ...
                  <button type="button" class="w-100 btn btn-sm btn-outline-secondary">Recarga</button>
